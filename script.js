/* ===========================================================
   FlyClash Converter PRO - Logic Controller
   =========================================================== */
...
// --- Parsing Logic (Tetap sama seperti original) ---
...
function makeOverride(clashNodes, opts){
    ...
    try {
        const targetGroups = ['🚀 节点选择', 'Proxy', 'Auto', 'Select'];
        ...
        // Ensure our group is at the top
    ...
    return `// FlyClash Override Generated at ${new Date().toLocaleString()}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    el.btnGen.addEventListener('click', () => {
        ...
        // Generate Simple YAML for preview
